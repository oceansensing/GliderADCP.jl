...
| **7 — extensions** | shear-bias correction **done (2026-07-07)**: pairwise-difference track-frame calibration (`calibrate_shear_bias!`; M38: −4×10⁻⁴ s⁻¹ removed to machine zero, residual < 10⁻⁴ at all depths, inverse invariant by construction; remaining shear-inverse gap = intrinsic integration noise, documented). Remaining: flight model, compass cal (incl. the yo 8–18 outlier check), burst/EVR, DIVAnd sections | per-feature |
